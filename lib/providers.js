...
const PROVIDERS = [
  { id: "cerebras", base: "https://api.cerebras.ai/v1", models: ["gpt-oss-120b", "zai-glm-4.7"], key: () => cfg("CEREBRAS_API_KEY") },
  { id: "groq", base: "https://api.groq.com/openai/v1", models: ["llama-3.3-70b-versatile", "llama-3.1-8b-instant"], key: () => cfg("GROQ_API_KEY") },
  { id: "opencode", base: "https://opencode.ai/zen/v1", models: ["laguna-s-2.1-free", "nemotron-3-ultra-free", "longcat-2.0-free"], key: () => cfg("OPENCODE_API_KEY") },
];
