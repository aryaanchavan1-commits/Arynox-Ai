...
const TOOLS = [
  ...
  { type: "function", function: { name: "deep_research", description: "DEEP research: expands the question into multiple search queries, searches the web, reads several full pages and returns a cited dossier. Use for important, detailed, multi-topic or current questions where a single search is not enough. Takes 20-60 seconds.", parameters: { type: "object", properties: { question: { type: "string", description: "The research question" } }, required: ["question"] } } },
...
BEHAVIOR:
1. RESEARCH: For quick facts use web_search. For important, detailed or multi-topic questions use deep_research (it searches several angles and reads full pages, takes 20-60s) and write the final answer from its dossier with [1][2] citations and a Sources list.
