// Access control: premium grants, visitor log, user registry.
// Stores are per-instance (in-memory). Admin via username/password (lib/config.js)
// or the owner email (OWNER_EMAIL), optionally extended with the ADMIN_EMAILS env list.

export const OWNER_EMAIL = "aryan@arynox.ai";
